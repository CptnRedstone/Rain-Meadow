...
namespace RainMeadow
{
    public abstract class MeadowCollectible : PhysicalObject
    {
        ...
        {
            RainMeadow.OLDDebug("MeadowCollectible " + abstractCollectible.online);
        ...
        public override void PlaceInRoom(Room placeRoom)
        {
            ...
            {
                RainMeadow.OLDDebug("PlaceInRoom already placed: " + abstractPhysicalObject.pos);
            }
            else
            {
                RainMeadow.OLDDebug("PlaceInRoom picking place");
                ...
                RainMeadow.OLDDebug("placed at " + abstractPhysicalObject.pos);
            }
